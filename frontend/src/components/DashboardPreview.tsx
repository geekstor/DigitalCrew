        ...
        <div className="bg-white rounded-3xl p-8 shadow-xl shadow-black/5">
              ...
              return (
                <div key={index} className="bg-[#F5F5F5] rounded-xl p-5">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <Icon className="w-4 h-4 text-[#6ADBCD]" />
                  </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-4">
              <h3>Active Agents</h3>
              <Button className="bg-[#6ADBCD] hover:bg-[#4FD6C9] text-white rounded-full">
                Create New Agent
              </Button>
            </div>
              ...
              {activeAgents.map((agent, index) => (
                ...
                >
                  <div className="flex items-center gap-4">
                    <div className="w-10 h-10 rounded-full bg-[#6ADBCD]/10 flex items-center justify-center">
                      <Activity className="w-5 h-5 text-[#6ADBCD]" />
                    </div>
                    <div>
                      <div>{agent.name}</div>
